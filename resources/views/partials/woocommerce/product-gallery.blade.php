    ...
    <div class="product-gallery"
         x-data="{
            ...
            handleLightboxTouchEnd(e) {
                if (!this.isLightboxTouch) return;
        ...
        <div class="main-image-container relative overflow-hidden cursor-pointer"
            ...
            {{-- Иконка увеличения --}}
            <div class="absolute top-3 left-3 bg-black/50 text-white p-2 rounded-full backdrop-blur-sm pointer-events-none">
        ...
        <div x-show="lightboxOpen"
             ...
             @touchstart="handleLightboxTouchStart($event)"
             @touchend="handleLightboxTouchEnd($event)">
            ...
            <div class="relative max-w-full max-h-full p-4">
                ...
                <template x-if="images.length > 1">
                    <div>
                        ...
                        {{-- Счетчик в lightbox --}}
                        <div class="absolute bottom-6 left-1/2 transform -translate-x-1/2 text-white bg-black/50 px-4 py-2 rounded-full text-sm backdrop-blur-sm">
