...
class ProductLinksTab extends BaseTab
{
    ...
    public static function getFields(): array
    {
        return [
            ...
            [
                ...
                'maxlength' => 200,
                'conditional_logic' => self::getConditionalLogicForProductTypesAndField(['companies', 'social_media_assets'], 'field_links_enabled', '1'),
            ],
            [
    ...
    private static function getLinksForTemplate(WC_Product $product): ?array
    {
        ...
        if (!self::isEnabledForProductType($product, ['companies', 'social_media_assets']) || !self::isLinksEnabled($product)) {
            return null;
        }
